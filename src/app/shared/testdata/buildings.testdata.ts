...
import { MachineCategory, MachineDefinition } from '../models/machine.model';
...
export const machinesTestData: MachineDefinition[] = [
  // Extraction
  {
    ...
    category: MachineCategory.extraction,
    icon: faIndustry,
    tier: 0,
    powerConsumption: 5,
  ...
  // Power
  {
    ...
    category: MachineCategory.power,
    icon: faBolt,
    tier: 0,
    powerProduction: 30,
    dimensions: { width: 2, height: 2 }
  ...
  // Storage
  {
    ...
    category: MachineCategory.storage,
    icon: faCubes,
    tier: 0,
    dimensions: { width: 2, height: 2 }
  },
  ...
  // Logistics
  {
    ...
    category: MachineCategory.logistics,
    icon: faNetworkWired,
    tier: 0,
